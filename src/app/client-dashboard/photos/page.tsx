      ...
      <main className="container mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="mb-4 sm:mb-6">
            <Link 
              href="/client-dashboard"
              className="inline-flex items-center px-3 sm:px-4 py-2 text-teal-600 hover:text-teal-700 hover:bg-teal-50 rounded-lg transition-colors group text-sm sm:text-base"
            >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <div className="flex items-center space-x-3 mb-2">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">Фотографии с объекта</h1>

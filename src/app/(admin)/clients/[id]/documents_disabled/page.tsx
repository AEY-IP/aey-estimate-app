...
import { ArrowLeft, Plus, FileText, Upload, Eye, Download } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Договоры и техническая документация</p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Документов пока нет</h3>
          <p className="text-gray-600 mb-6">Загрузите первые документы для клиента</p>
